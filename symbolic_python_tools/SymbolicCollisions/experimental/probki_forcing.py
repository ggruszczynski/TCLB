...
# F_cm = get_cm_vector_from_continuous_def(get_continuous_force_He_second_order_MB)  # produces looong expressions
...
print('\n//F_cm_Guo_extended')
F_cm_Guo_extended = get_cm_vector_from_discrete_def(lambda i: w[i])
print_as_vector(F_cm_Guo_extended, 'F_cm', regex=True)


print('\n//N*M*F_cm_Guo_extended ')
F_cm_Guo_extended = get_cm_vector_shift_NM(lambda i: w[i])
print_as_vector(F_cm_Guo_extended, 'F_cm', regex=True)
