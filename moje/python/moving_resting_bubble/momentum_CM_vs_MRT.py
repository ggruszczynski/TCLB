...
folder_path = os.path.join("~/DATA_FOR_PLOTS",
                           ...
                           f"rho{rho_ratio}_v{v}_L_U{U}_Sige-6","forces" )
...
frame_cm_resting = pd.read_csv(os.path.join(folder_path, f"cm_resting_{what}_Log_P00_00000025.csv"), delimiter=",")
frame_mrt_resting = pd.read_csv(os.path.join(folder_path, f"mrt_resting_{what}_Log_P00_00000025.csv"), delimiter=",")
frame_cm_moving = pd.read_csv(os.path.join(folder_path, f"cm_moving_{what}_Log_P00_00000025.csv"), delimiter=",")
frame_mrt_moving = pd.read_csv(os.path.join(folder_path, f"mrt_moving_{what}_Log_P00_00000025.csv"), delimiter=",")
...
def make_plot(frame_moving, frame_resting, plot_name):
    ...
    plt.tight_layout()
    fig.savefig(f'{plot_name}s_forces_rho{rho_ratio}_v{v}_U{U}.png')
