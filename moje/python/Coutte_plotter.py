...
u_anal = [u_Couette_anal(x_rho[i], mi_h=1.0, mi_l=0.01) for i in range(len(x_rho))]

# x_anal = np.linspace(0, 100, num=100)
...
# plt.plot(x_anal, u_anal_1000/max(u_anal_1000), color="blue",  linestyle="--", label=r'$\mu^* = 1000$')
# plt.plot(x_anal, u_anal_54/max(u_anal_54), color="red", label=r'$\mu^* = 54.6$')
# plt.plot(x_anal, u_anal_10/max(u_anal_10), color="green", linestyle="--", label=r'$\mu^* = 10$')
#

plt.plot(x_rho/max(x_rho), u_anal/max(u_anal), color="red", label=r'$u_{analytical}$')
plt.plot(x_rho/max(x_rho), u_rho/max(u_anal), color="green", linestyle="--", label=r'$rho^* = 100$')
plt.plot(x_v/max(x_v), u_v/max(u_anal), color="blue",  linestyle="--", label=r'$v^* = 100$')
