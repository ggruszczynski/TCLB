...
u_anal = [u_Couette_anal(x_anal[i], mi_h=1.0, mi_l=0.01) for i in range(len(x_anal))]
...
plt.plot(u_anal_1000/max(u_anal_1000), x_anal/len(x_anal), color="blue",  linestyle="--", label=r'$\mu^* = 1000$')
plt.plot(u_anal_54/max(u_anal_54), x_anal/len(x_anal), color="red", label=r'$\mu^* = 54.6$')
plt.plot(u_anal_10/max(u_anal_10), x_anal/len(x_anal), color="green", linestyle="--", label=r'$\mu^* = 10$')


# plt.plot(u_anal/max(u_anal), x_rho/max(x_rho), color="red", label=r'$u_{analytical}$')
# plt.plot(u_rho/max(u_anal), x_rho/max(x_rho), color="green", linestyle="--", label=r'$\rho^* = 100$')
# plt.plot(u_v/max(u_anal), x_v/max(x_v), color="blue",  linestyle="--", label=r'$v^* = 100$')
