...
AddDensity(name="conductivity_brush", group="porous_media", comment="extra conductivity", parameter=TRUE)
...
AddSetting(name="InitRho", 				default=1.0, 		comment='density of fluid [kg/m3]', 				zonal=T)
...
#   Inputs: Porous media
AddSetting(name="Kazeny_Hcoeff", 		default=1.0, 		comment='Kazeny_coeff for thermal field')
AddSetting(name="Kazeny_NScoeff", 		default=1.0, 		comment='Kazeny_coeff for fluid')
...
AddNodeType(name="CM_HIGHER_INCOMPRESSIBLE",group="COLLISION")
...
AddNodeType(name="RhoSource", group="BOUNDARY")
AddNodeType(name="RhoDirichletEQ", group="BOUNDARY")
