...
CudaDeviceFunction void relax_central_moments(real_t f_out[9], real_t f_in[9], real_t tau, vector_t Fhydro, vector_t u)
{
	...
	f_in[0] = f_in[0] + f_in[1] + f_in[2] + f_in[3] + f_in[4] + f_in[5] + f_in[6] + f_in[7] + f_in[8];
	f_in[1] = f_in[1] - f_in[3] + f_in[5] - f_in[6] - f_in[7] + f_in[8];
	f_in[2] = f_in[2] - f_in[4] + f_in[5] + f_in[6] - f_in[7] - f_in[8];
	f_in[3] = f_in[1] + f_in[3] + f_in[5] + f_in[6] + f_in[7] + f_in[8];
	f_in[4] = f_in[2] + f_in[4] + f_in[5] + f_in[6] + f_in[7] + f_in[8];
	f_in[5] = f_in[5] - f_in[6] + f_in[7] - f_in[8];
	f_in[6] = f_in[5] + f_in[6] - f_in[7] - f_in[8];
	f_in[7] = f_in[5] - f_in[6] - f_in[7] + f_in[8];
	f_in[8] = f_in[5] + f_in[6] + f_in[7] + f_in[8];
	
	//central moments from moments
	f_in[0] = f_in[0];
	f_in[1] = -f_in[0]*u.x + f_in[1];
	f_in[2] = -f_in[0]*u.y + f_in[2];
	f_in[3] = f_in[0]*ux2 - 2*f_in[1]*u.x + f_in[3];
	f_in[4] = f_in[0]*uy2 - 2*f_in[2]*u.y + f_in[4];
	f_in[5] = f_in[0]*uxuy - f_in[1]*u.y - f_in[2]*u.x + f_in[5];
	f_in[6] = -f_in[0]*ux2*u.y + 2*f_in[1]*uxuy + f_in[2]*ux2 - f_in[3]*u.y - 2*f_in[5]*u.x + f_in[6];
	f_in[7] = -f_in[0]*u.x*uy2 + f_in[1]*uy2 + 2*f_in[2]*uxuy - f_in[4]*u.x - 2*f_in[5]*u.y + f_in[7];
	f_in[8] = f_in[0]*ux2*uy2 - 2*f_in[1]*u.x*uy2 - 2*f_in[2]*ux2*u.y + f_in[3]*uy2 + f_in[4]*ux2 + 4*f_in[5]*uxuy - 2*f_in[6]*u.y - 2*f_in[7]*u.x + f_in[8];
	
	//collision in central moments space
	f_in[0] = m00;
	f_in[1] = Fhydro.x/2;
	f_in[2] = Fhydro.y/2;
	f_in[3] = (m00/3.)*(-s_v/2 + 1.0) + (m00/3.)*(s_v/2 + 1.0) - f_in[3]*s_v/2 + f_in[4]*(s_v/2 - 1.0);
	f_in[4] = (m00/3.)*(-s_v/2 + 1.0) + (m00/3.)*(s_v/2 + 1.0) + f_in[3]*(s_v/2 - 1.0) - f_in[4]*s_v/2;
	f_in[5] = f_in[5]*(-s_v + 1);
	f_in[6] = (Fhydro.y/3.)/2;
	f_in[7] = (Fhydro.x/3.)/2;
	f_in[8] = (m00/9.);
	...
	f_out[0] = f_in[0] - f_in[3] - f_in[4] + f_in[8];
	f_out[1] = f_in[1]/2 + f_in[3]/2 - f_in[7]/2 - f_in[8]/2;
	f_out[2] = f_in[2]/2 + f_in[4]/2 - f_in[6]/2 - f_in[8]/2;
	f_out[3] = -f_in[1]/2 + f_in[3]/2 + f_in[7]/2 - f_in[8]/2;
	f_out[4] = -f_in[2]/2 + f_in[4]/2 + f_in[6]/2 - f_in[8]/2;
	f_out[5] = f_in[5]/4 + f_in[6]/4 + f_in[7]/4 + f_in[8]/4;
	f_out[6] = -f_in[5]/4 + f_in[6]/4 - f_in[7]/4 + f_in[8]/4;
	f_out[7] = f_in[5]/4 - f_in[6]/4 - f_in[7]/4 + f_in[8]/4;
	f_out[8] = -f_in[5]/4 - f_in[6]/4 + f_in[7]/4 + f_in[8]/4;
...
CudaDeviceFunction void CollisionCM() {
    ...
    real_t d = getRho();
    real_t f_out[9], f_in[9];
    for (int i=0; i< 9; i++) {
        f_in[i] = f[i];	
	}
	
    vector_t force; //in the middle of the time step
    ...
    relax_central_moments(f_out, f_in, 1./omega, force, u);
    for (int i=0; i< 9; i++) {
		f[i] = f_out[i];
    }
}
