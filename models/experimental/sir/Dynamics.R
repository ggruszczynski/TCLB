...
AddSetting(name="InitInfected", comment='People infected', unit="1", zonal=TRUE)
AddSetting(name="InitImmunisation", comment='People immunised', unit="1", zonal=TRUE)
AddSetting(name="InitSusceptible", comment='People susceptible', unit="1", zonal=TRUE)

AddGlobal(name="TotalSusceptible")
